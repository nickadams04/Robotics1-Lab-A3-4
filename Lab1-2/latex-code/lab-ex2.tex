...
Στην προηγούμενη ενότητα παρατηρήσαμε ότι ο γραμμικός ελεγκτής PD, παρότι κατάφερε να σταθεροποιήσει το σύστημα, παρουσίασε σημαντικό σφάλμα μόνιμης κατάστασης \(e_{ss}\), ακόμη και για τις βέλτιστες τιμές κερδών. Αυτό οδήγησε στην ανάγκη εισαγωγής της αντιστάθμισης βαρύτητας.

Η αντιστάθμιση βαρύτητας (gravity compensation) είναι η τεχνική κατά την οποία προσθέτουμε στον νόμο ελέγχου έναν υπολογισμένο όρο, ο οποίος ισούται με τη ροπή που ασκεί η βαρύτητα στους συνδέσμους του ρομπότ στην τρέχουσα θέση τους. Είναι απαραίτητη, διότι ένας απλός ελεγκτής PD παράγει ροπή μόνο όταν υπάρχει σφάλμα θέσης. Επειδή η βαρύτητα ασκεί συνεχή δύναμη στο Pendubot (προσπαθώντας να το κατεβάσει), ο ελεγκτής PD αναγκάζεται να διατηρεί ένα μόνιμο σφάλμα, ώστε να παράγει την απαιτούμενη ροπή συγκράτησης.

Εισάγοντας τον όρο αντιστάθμισης \(g(q)\), που υπολογίσαμε στη θεωρητική ανάλυση, παίρνουμε τον νέο νόμο ελέγχου
\[
u(t) = K_p\, e(t) + K_d\, \dot e(t) + g(q).
\]

Για τα βέλτιστα κέρδη \(K_p, K_d\) που βρήκαμε στο προηγούμενο κομμάτι, δηλαδή \((K_p, K_d) = (20,\, 0.95)\), προκύπτουν οι τιμές:
\[
...
Φαίνεται λοιπόν πως πετύχαμε σημαντική βελτίωση στο σφάλμα μόνιμης κατάστασης, ενώ ο χρόνος ανύψωσης και το ποσοστό υπερύψωσης έμειναν πρακτικά αμετάβλητα. Να σημειωθεί πως το ρομπότ σταθεροποιήθηκε σε θέση ελαφρώς ψηλότερη από την επιθυμητή και αυτό μπορεί να οφείλεται είτε σε σφάλμα στον υπολογισμό των σταθερών \(\varphi_1, \varphi_2\) είτε στη στατική τριβή του μηχανισμού.
